...
Nous avons d'abord cherché une composition optimale en se limitant aux 3 composants de base qu'on retrouve dans la plupart de verres : $SiO_2$, $NaO_2$ et $CaO$. Pour cela on a modifié la fonction de tirage au sort pour se limiter aux mélanges de ces 3 éléments. On a ensuite trié la liste de compositions obtenues afin de trouver celle qui correspond le mieux à nos exigences.
