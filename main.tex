...
Nous disposons de plusieurs modèles entrainés sur la base de données INTERGLAD qui permettent de prédire les propriétés du verre à partir de sa composition. Nous cherchons à déterminer un verre dont les fractions molaires vérifient :
...
Nous souhaitons obtenir un verre qui possède les propriétés suivantes :
...
Pour fabriquer le verre nous avons accès aux composantes suivantes : $SiO_2$, $Al_2O_3$, $MgO$, $CaO$, $Na_2O$, $K_2O$, $ZnO$, $TiO_2$
