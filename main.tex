...
Nous disposons de plusieurs modèles entrainés sur la base de données INTERGLAD qui permettent de prédire les propriétés du verre à partir de sa composition. Nous chercheons à déterminer le verre dont les fractions molaires vérifient :
...
Nous souhaiteons obtenir un verre qui possède les propriétés suivantes :
