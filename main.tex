...
Le verre obtenu a une couleur légèrement jaune, vraisemblablement due à la présence de titane dans la composition. De plus, il s'est fissuré lors du refroidissemnt brutal, sous l'effet des contraintes.
\subsection{Recuisson du verre }
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.25\textwidth}
        \centering
        \includegraphics[width=\textwidth]{photos/morceau2_après.jpg}
...
\begin{figure}[ht]
    ...
    \includegraphics[width=0.7\textwidth]{photos/graphe viscosité.png}
