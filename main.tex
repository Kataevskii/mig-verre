...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{mosaic.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{contraintes.jpg}
...
\begin{figure}[h!]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{impuetée2.jpg}
        \caption{infondus observés au microscope optique}
    \end{minipage}
    \hspace{0.5cm}
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{rayon 1.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{impuetée3.jpg}
    \caption{observation des contraintes dans le verre à la lumière polarisée}
\end{figure}
